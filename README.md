...
`교무팀 - 전임교원 급여 및 보상`과 `교무팀 - 전임교원 신규임용`으로 소속을 화면 직무명에 명시했습니다. 교무팀 업무가 정확히 4개이므로, 편성 조건이 충족되는 경우 A·B·C·D조에 하나씩 배치됩니다. 구버전 Google Sheets에 저장된 소속 미표기 직무명은 새 명칭으로 자동 합산됩니다.
